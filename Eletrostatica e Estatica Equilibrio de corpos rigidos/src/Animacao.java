...
public class Animacao extends JFrame {
    ...
    // Representa uma esfera de carga a ser desenhada (posição, cor, rótulo)
    ...
    static class AnimacaoPanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            // As 4 esferas de carga (q, 2q na barra; Q, Q fixas no chão)
        ...
        // Desenha uma esfera com borda branca e rótulo centralizado em cima da cor de fundo
