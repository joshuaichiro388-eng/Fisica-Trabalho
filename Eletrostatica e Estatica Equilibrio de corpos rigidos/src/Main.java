...
public class Main {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            JTextField tfL = new JTextField("1.0");
            JTextField tfP = new JTextField("10.0");
            JTextField tfQ = new JTextField("1e-6");
            JTextField tfq = new JTextField("1e-6");
            JTextField tfh = new JTextField("0.1");
            JTextField tfx = new JTextField("0.3");
            ...
            JButton animBtn = new JButton("Ver animação");
            ...
            calcBtn.addActionListener(e -> {
                try {
                    ...
                    // Atualiza o campo x com o resultado calculado.
                    // Locale.US garante separador decimal "." (Double.parseDouble não aceita vírgula).
